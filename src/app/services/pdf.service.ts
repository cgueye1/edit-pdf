  ...
  private async drawFieldOnDoc(
    ...
    switch (field.type) {
      ...
      case 'checkbox': {
        ...
        const by =
          field.y + (checkboxHeight - checkboxSize) / 2 + checkboxSize * 0.03;
        ...
        if (field.value === true) {
          ...
          page.drawLine({
            start: { x: bx + crossOffset, y: by + crossOffset },
              ...
              x: bx + checkboxSize - crossOffset,
              y: by + checkboxSize - crossOffset,
            },
            color: rgb(0, 0, 0),
            thickness,
          });
